...
The program can also be run through the BSYHC compiler in interpret mode (see [section 14](#14-bsyhc--the-compiler)):
...
BSYHC can also build the program into a binary file via PyInstaller (`--onefile`):
